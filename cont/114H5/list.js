						...
						for(var i in mes){
							if(mes.length > 1){
								if(mes[i].saleStatus=='1'){
									...
									str+='</dl>'
									//str+='<dl dataid="'+mes[inx].productId+'"><dt><i class="hot"></i><img src="'+list.iconUrl+'" /></dt><dd><p searchName="'+list.productName+'" class="p1">'+list.productName+'</p><p class="p2">'+list.standard+'</p></dd></dl>'
								}else{
...
$(function(){	
 	...
 	myScroll.on('scroll', function(){
   	...
   	myScroll.on("scrollEnd",function(){
   		if((myScroll.y-myScroll.maxScrollY)>15){
   			if(!countPage && scrollDown){
   				listByPage.getMes();
   				myScroll.refresh();
   			}
   		}
